#!/usr/bin/env python3
"""
withings/poller.py — triggers a Withings data sync via the Bacta API.
Called by health_poller.py when withings_enabled=true in app_settings.
...
try:
    ...
    print('[withings] requests library not installed — run: pip3 install requests', file=sys.stderr)
    sys.exit(1)
