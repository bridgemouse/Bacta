...
const BACTA = {
  ...
  section: {
    // Clinical instrument-channel palette — spaced around the wheel,
    // cyan band reserved for MX-4 so nothing competes with his identity.
    recovery:  { label: 'Recovery',   accent: '#7c9af8' }, // periwinkle — restoration (was cyan-adjacent blue)
    training:  { label: 'Training',   accent: '#f5853a' }, // ember — exertion
    sleep:     { label: 'Sleep',      accent: '#b08cf0' }, // lilac — rest
