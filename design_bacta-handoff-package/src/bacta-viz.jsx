    ...
    <div style={{ position: 'relative', borderRadius: 14, marginBottom: 4, overflow: 'hidden',
      ...
      <div style={{ position: 'relative', display: 'flex', alignItems: 'center', gap: 9, padding: '12px 15px 0' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 1, flex: 1, minWidth: 0 }}>
          <span style={{ fontFamily: MONO, fontSize: 9.5, letterSpacing: '0.14em', color: accent, fontWeight: 700, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>MX-4 <span style={{ color: color.text3 }}>//</span> {label}</span>
          <span style={{ fontFamily: MONO, fontSize: 8, letterSpacing: '0.1em', color: color.text3, whiteSpace: 'nowrap' }}>{brief.meta}</span>
        </div>
